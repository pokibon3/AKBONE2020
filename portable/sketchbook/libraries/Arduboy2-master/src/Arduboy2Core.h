...
#endif
//
// Audio Definition : not used if ArduboyTones version
//
#ifdef SLIMBOY
  #ifdef AKBONEBOY
    #define PIN_SPEAKER_1 15 /**< The pin number of the first lead of the speaker */
